...
goog.require('reagent.core');
goog.require('reagent.core');
main.core.on_change = (function on_change(event,fb){cljs.core.println.call(null,"snapshotsnapshotsnapshitsn:");
cljs.core.println.call(null,fb);
cljs.core.println.call(null,"snapshotsnapshotsnapshitsn:");
fb.set(cljs.core.clj__GT_js.call(null,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"text-from-app","text-from-app",-1807524948),event.target.value], null)));
