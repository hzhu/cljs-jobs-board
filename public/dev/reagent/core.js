...
var G__5412__delegate = function (x,rest){return cljs.core.apply.call(null,reagent.ratom.atom,x,rest);
};
var G__5412 = function (x,var_args){
var rest = null;if (arguments.length > 1) {
  rest = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return G__5412__delegate.call(this,x,rest);};
G__5412.cljs$lang$maxFixedArity = 1;
G__5412.cljs$lang$applyTo = (function (arglist__5413){
var x = cljs.core.first(arglist__5413);
var rest = cljs.core.rest(arglist__5413);
return G__5412__delegate(x,rest);
});
...
partial.cljs$lang$applyTo = (function (arglist__5414){
