...
{var name_str = cljs.core.name.call(null,dashed);var vec__5560 = clojure.string.split.call(null,name_str,/-/);var start = cljs.core.nth.call(null,vec__5560,(0),null);var parts = cljs.core.nthnext.call(null,vec__5560,(1));if(cljs.core.truth_(reagent.impl.util.dont_camel_case.call(null,start)))
{return name_str;
} else
...
reagent.impl.util.partial_ifn.cljs$lang$ctorPrWriter = (function (this__4111__auto__,writer__4112__auto__,opt__4113__auto__){return cljs.core._write.call(null,writer__4112__auto__,"reagent.impl.util/partial-ifn");
});
...
reagent.impl.util.clj_ifn_QMARK_ = (function clj_ifn_QMARK_(x){var or__3544__auto__ = cljs.core.ifn_QMARK_.call(null,x);if(or__3544__auto__)
...
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IMultiFn,G__5571);
} else
{return false;
}
}
...
{var and__3532__auto__ = cljs.core.map_QMARK_.call(null,x);if(and__3532__auto__)
{var and__3532__auto____$1 = cljs.core.map_QMARK_.call(null,y);if(and__3532__auto____$1)
{var and__3532__auto____$2 = (cljs.core.count.call(null,x) === cljs.core.count.call(null,y));if(and__3532__auto____$2)
{return cljs.core.reduce_kv.call(null,((function (and__3532__auto____$2,and__3532__auto____$1,and__3532__auto__,or__3544__auto__){
return (function (res,k,v){var yv = cljs.core.get.call(null,y,k,reagent.impl.util._not_found);if(cljs.core.truth_((function (){var or__3544__auto____$1 = (v === yv);if(or__3544__auto____$1)
{return or__3544__auto____$1;
} else
{var or__3544__auto____$2 = reagent.impl.util.identical_ish_QMARK_.call(null,v,yv);if(or__3544__auto____$2)
{return or__3544__auto____$2;
} else
{var and__3532__auto____$3 = cljs.core.keyword_identical_QMARK_.call(null,k,new cljs.core.Keyword(null,"style","style",-496642736));if(and__3532__auto____$3)
...
{var and__3532__auto__ = (cljs.core.count.call(null,v1) === cljs.core.count.call(null,v2));if(and__3532__auto__)
{return cljs.core.reduce_kv.call(null,((function (and__3532__auto__,or__3544__auto__){
return (function (res,k,v){var v_SINGLEQUOTE_ = cljs.core.nth.call(null,v2,k);if(cljs.core.truth_((function (){var or__3544__auto____$1 = (v === v_SINGLEQUOTE_);if(or__3544__auto____$1)
{return or__3544__auto____$1;
} else
{var or__3544__auto____$2 = reagent.impl.util.identical_ish_QMARK_.call(null,v,v_SINGLEQUOTE_);if(or__3544__auto____$2)
{return or__3544__auto____$2;
} else
{var and__3532__auto____$1 = cljs.core.map_QMARK_.call(null,v);if(and__3532__auto____$1)
